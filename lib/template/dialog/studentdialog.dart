...
class AddStudentDialog extends StatefulWidget {
  ...
  AddStudentDialog({super.key, @required this.notifyParent, this.student, this.selectedClasse});
  @override
...
class _AddStudentDialogState extends State<AddStudentDialog> {
  ...
  void initState() {
    super.initState();
    selectedClass = widget.selectedClasse; // Set selectedClass to the value from the constructor
